...
struct ContentView: View {
    ...
    @State private var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 42.1539, longitude: -88.1362), span: MKCoordinateSpan(latitudeDelta: 0.05, longitudeDelta: 0.05))
